...
<%
	...
	usuario = new UsuarioDAO().PesquisarID(usuario);
     %>
	...
	<div style="background-color:#069; text-align: center">
		<h2 align="center"><font size="+4" color="#FFFBF0">Alterar de Usuário</font></h2>
		<form id="cadastrousuario" style="background-color:#069"
			action="ControladorUsuario?cmd=alterar&id=<%=usuario.getCodigo()%>"
			...
			<table align="center">
				<tr>
					...
					<td width="163" align="center"><input type="text" name="nome"
						maxlength="40" value="<%=usuario.getNome()%>" onchange="up(this)"/></td>
				</tr>
				<tr>
					...
					<td width="163" align="center"><input type="text" name="cpf"
						maxlength="14" id="cpf" onblur="return VerificaCPF(cpf.value)" value="<%=usuario.getCPF() %>"/></td>
				</tr>
				<tr>
					...
					<td width="163" align="center"><input type="text" name="login"
						maxlength="20" id="login" value="<%=usuario.getLogin()%>" onchange="up(this)"/></td>
				</tr>
				<tr>
