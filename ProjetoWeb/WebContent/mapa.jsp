...
<script type="text/javascript">
	function initialize() {
		...
		var lat_long_nMusic = new google.maps.LatLng(-8.282214122086744,
				-35.9713783008026);
		var lat_long_correios = new google.maps.LatLng(-8.281891030842033,
				-35.968933622476186);
		...
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li class="current_page_item"><a href="mapa.jsp" accesskey="2"
						title="">Google Maps - Caruaru</a></li>
					<li><a href="ControladorUsuario?cmd=logout" accesskey="3"
						title="">Sair</a></li>
				</ul>
			</div>
		</div>
	...
	<div id="copyright" class="container">
		<p>
			...
			direitos reservados. | Design by <a
				href="http://www.facebook.com.br/diego.vaz.gomes" target="_blank"
				rel="nofollow">Diêgo Vaz Gomes</a>.
		</p>
	</div>
</body>
</html>