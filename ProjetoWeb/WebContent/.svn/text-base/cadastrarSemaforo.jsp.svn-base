...
if (session == null || session.getAttribute("usuarioLogado") == null) {
 response.sendRedirect("index.jsp");
	...
	<div style="background-color:#069; text-align: center">
		<h2 align="center"><font size="+4" color="#FFFBF0">Cadastro de Semáforo</font></h2>
			...
			<table align="center">
				...
				<tr>
					...
					<td width="163" align="center"><input type="radio"
						name="sentido" value="UNICO" /><b><font size="+1" color="#FFFBF0">UNICO</font></b><input type="radio"
						name="sentido" value="DUPLO" /><b><font size="+1" color="#FFFBF0">DUPLO</font></b></td>
				</tr>
				<tr>
					<td width="150" height="50" align="center"><b><font size="+1" color="#FFFBF0">Cruzamento:</font></b></td>
					<td width="163" align="center"><input type="radio"
						name="cruzamento" value="SIM" /><b><font size="+1" color="#FFFBF0">SIM</font></b><input type="radio"
						name="cruzamento" value="NAO" /><b><font size="+1" color="#FFFBF0">NAO</font></b></td>
				</tr>
			</table>
